...
- [customDockerLambda](QaAppsyncOpensearchProps.md#customdockerlambda)
...
• `Optional` `Readonly` **customDockerLambda**: [`DockerLambdaCustomProps`](DockerLambdaCustomProps.md)
