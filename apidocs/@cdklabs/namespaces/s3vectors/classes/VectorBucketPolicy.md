...
[@cdklabs/generative-ai-cdk-constructs](../../../../README.md) / [s3vectors](../README.md) / VectorBucketPolicy
...
> **new VectorBucketPolicy**(`scope`, `id`, `props`): `VectorBucketPolicy`
...
[`VectorBucketPolicyProps`](../interfaces/VectorBucketPolicyProps.md)
...
> `readonly` **bucket**: [`IVectorBucket`](../interfaces/IVectorBucket.md)
...
`IVectorBucketPolicyRef.vectorBucketPolicyRef`
...
> **applyRemovalPolicy**(`removalPolicy`): `void`
...
> `static` **fromCfnVectorBucketPolicy**(`cfnVectorBucketPolicy`): `VectorBucketPolicy`
