...
[`ClusterBase`](ClusterBase.md).[`applyCrossStackReferenceStrength`](ClusterBase.md#applycrossstackreferencestrength)
...
[`ClusterBase`](ClusterBase.md).[`with`](ClusterBase.md#with)
