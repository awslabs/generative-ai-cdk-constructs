...
from .config_file_loader import on_event as config_file_loader_on_event
...
def on_event(event: CustomResourceRequest, context):
    ...
    if resource_type == "Custom::ConfigFileLoader":
        return config_file_loader_on_event(event, context)
