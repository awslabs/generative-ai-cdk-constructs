...
After deploying the CDK stack, the document summarization workflow can be invoked using GraphQL APIs. The API schema details are [here](https://github.com/awslabs/generative-ai-cdk-constructs/blob/main/resources/gen-ai/aws-rag-appsync-stepfn-opensearch/schema.graphql).
...
- id string
- props [RagAppsyncStepfnOpensearchProps](/docs/api/interfaces/RagAppsyncStepfnOpensearchProps)
