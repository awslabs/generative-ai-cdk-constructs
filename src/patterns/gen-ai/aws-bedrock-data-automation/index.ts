...
export class BedrockDataAutomation extends BaseClass {
  ...
  /**
   * The properties for configuring the Bedrock Data Automation construct.
   */
  ...
  // ------------------------------------------------------
  /**
   * Gets the S3 bucket for input data used by the Bedrock Data Automation process.
   */
  public get inputBucket(): s3.IBucket {
    return this.bdaInputBucket;
  }
  /**
   * Gets the S3 bucket for output data generated by the Bedrock Data Automation process.
   */
  public get outputBucket(): s3.IBucket {
    return this.bdaOutputBucket;
  }
  /**
   * Gets the Lambda function responsible for creating the Bedrock Data Automation blueprint.
   */
  public get blueprintLambdaFunction(): lambda.Function {
    return this.bdaBlueprintLambdaFunction;
  }
  /**
   * Gets the Lambda function responsible for handling the Bedrock Data Automation project.
   */
  public get bdaProjectLambdaFunction(): lambda.Function {
    return this.bdaProjectFunction;
  }
  /**
   * Gets the Lambda function responsible for invoking the Bedrock Data Automation process.
   */
  public get bdaInvocationLambdaFunction(): lambda.Function {
    return this.bdaInvocationFunction;
  }
  /**
   * Gets the Lambda function responsible for checking the status of the Bedrock Data Automation process.
   */
