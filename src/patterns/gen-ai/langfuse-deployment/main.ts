 ...
 */
export class LangfuseDeployment extends BaseClass {
  ...
  constructor(scope: Construct, id: string, props: ILangfuseDeploymentProps) {
    ...
    const baseProps: BaseClassProps = {
      constructName: ConstructName.LANGFUSEDEPLOYMENT,
      constructId: id,
    };
    // TODO: What's the significance of the LambdaFunctions exactly?
