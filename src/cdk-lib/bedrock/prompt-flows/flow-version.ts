...
export interface FlowVersionProps {
  /**
   * The flow that this version belongs to.
   */
  readonly flow: Flow;
  /**
   * A description of the flow version
   */
...
export class FlowVersion extends Construct {
  ...
  constructor(scope: Construct, id: string, props: FlowVersionProps) {
    ...
    this._resource = new bedrock.CfnFlowVersion(this, `FlowVersion-${this.flow._hash.slice(0, 16)}`, {
