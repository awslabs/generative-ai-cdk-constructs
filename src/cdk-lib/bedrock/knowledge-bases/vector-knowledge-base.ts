...
import { CommonKnowledgeBaseProps, IKnowledgeBase, KnowledgeBaseBase, KnowledgeBaseType } from './knowledge-base';
 ...
 *****************************************************************************/
/**
 * Represents a Vector Knowledge Base, either created with CDK or imported.
 * This interface defines the methods and properties that a Vector Knowledge Base
 * should have, but not its implementation.
 */
 ...
 *****************************************************************************/
/**
 * Properties for a new vector knowledge base.
 */
 ...
 */
export interface VectorKnowledgeBaseAttributes {
  /**
 ...
 *****************************************************************************/
/**
 * Deploys a Vector Bedrock Knowledge Base and configures a backend by OpenSearch Serverless,
 * Pinecone, Redis Enterprise Cloud or Amazon Aurora PostgreSQL.
 */
export class VectorKnowledgeBase extends KnowledgeBaseBase {
  // ------------------------------------------------------
  // Import Methods
  // ------------------------------------------------------
  ...
  /**
   * The type of the vector store type.
   * @private
   */
